...
def update_reminder(index: int, updated_text: str, tool_context: ToolContext) -> dict:
    ...
    Args:
        ...
        updated_text: The next text for the reminder
        tool_context: Context for accessing and updating session state
...
memory_agent = Agent(
    ...
    **REMINDER MANAGEMENT GUIDELINESl**
    ...
    2. Whe the user mentions a number or position:
    ...
    4. For viewing:
        ...
        - If there are no reminders, suggest adding one
